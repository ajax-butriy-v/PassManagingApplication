...
class DtoVerifierBeanPostProcessor : BeanPostProcessor {
    ...
    override fun postProcessAfterInitialization(bean: Any, beanName: String): Any {
        return beanNameToClassMap[beanName]?.let { targetMethods ->
            createEnhancer(bean) { obj, method, args, proxy ->
                ...
                proxy.invokeSuper(obj, args ?: emptyArray()) // design something with try block
            }
        } ?: bean
    }
    ...
    internal data class DtoAnnotatedMethods(val beanClass: Class<*>, val methodsWithDto: Set<Method>)
}
