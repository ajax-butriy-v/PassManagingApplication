...
internal class GrpcPassServiceTest {
    @MockK
    private lateinit var natsHandlerPassMessageInPort: NatsHandlerPassMessageInPort
    ...
    fun `get all transferred passes by pass type name should return flux from nats subject`() {
        ...
        every {
            natsHandlerPassMessageInPort.getAllTransferredPasses(passTypeName)
    ...
    fun `creating pass should create a new pass`() {
        ...
        val createPassGrpcRequest = CreatePassRequest.newBuilder()
            ...
            .build()
        every {
            natsHandlerPassMessageInPort.createPass(passDto.toCreatePassRequest())
    ...
    fun `find by id should return pass by id`() {
        ...
        every {
            natsHandlerPassMessageInPort.findPassById(findPassByIdRequest(passId))
