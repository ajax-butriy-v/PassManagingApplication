package com.example.passmanagersvc.pass.service
...
import com.example.passmanagersvc.pass.application.port.service.PassService
...
internal class PassServiceImplTest {
    ...
    fun `creation should return new object with id`() {
        // GIVEN
        every { passOwnerServiceInputPort.getById(passOwnerIdFromDb) } returns passOwnerFromDb.toMono()
