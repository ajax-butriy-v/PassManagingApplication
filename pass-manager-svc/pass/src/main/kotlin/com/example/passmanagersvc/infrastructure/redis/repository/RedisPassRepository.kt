package com.example.passmanagersvc.infrastructure.redis.repository
...
class RedisPassRepository(
    ...
    private val mongoPassRepository: PassRepositoryOutPort,
    private val reactiveRedisTemplate: ReactiveRedisTemplate<String, ByteArray>,
    private val objectMapper: ObjectMapper,
) : PassRepositoryOutPort by mongoPassRepository {
